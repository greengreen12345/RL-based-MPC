...
class MazeEnv(gym.Env):
    def __init__(
        ...
        # self.model_cls_kwargs = kwargs
        # xml_path = os.path.join(MODEL_DIR, model_cls.FILE)
        # self.world_tree = ET.parse(xml_path)  # 初始化解析XML文件
        # self.reload_model(xml_path)

        self.reward_at_goal = 2.1  # reward given when agent reaches goal position
        ...
        self.reward_collision_with_agent = -0.55  # reward given when agent collides with another agent
        self.reward_collision_with_wall = -0.55  # reward given when agent collides with wall
        ...
        # self.reward_collision_with_agent = 0  # reward given when agent collides with another agent
        # self.reward_collision_with_wall = 0  # reward given when agent collides with wall
        # self.reward_collision_objball = 0
        # self.reward_getting_close = 0  # reward when agent gets close to another agent (unused?)
        # self.reward_entered_norm_zone = 0  # reward when agent enters another agent's social zone
        ...
        # TODO:
        self.goal_geom_id = self.wrapped_env.sim.model.geom_name2id("goal_geom")
    ...
    def update_goal_position(self, new_position):
        ...
        self.wrapped_env.sim.data.geom_xpos[self.goal_geom_id][:] = new_position

    def set_goal(self, goal_position):
        """ set goal position """
        self.goal_position = goal_position
        self.update_goal_position(self.goal_position)

    # def reload_model(self, file_path):
    #     self.wrapped_env = self.model_cls(file_path=file_path, **self.model_cls_kwargs)
    #
    # def update_goal_position(self, new_position):
    #     """ update goal position """
    #     # 创建新的 geom 名字
    #     new_geom_name = f"goal_geom_{self.goal_count}"
    #     self.goal_count += 1
    #
    #     # 获取世界 body 节点
    #     worldbody = self.world_tree.find(".//worldbody")
    #
    #     # 创建新的 geom
    #     ET.SubElement(
    #         worldbody,
    ...
    #         size="0.3",
    #         rgba="1 0 0 1",
    #         pos=f"{new_position[0]} {new_position[1]} {new_position[2]}"
    #     )
    #
    #     # 更新 XML 文件
    #     _, file_path = tempfile.mkstemp(text=True, suffix=".xml")
    #     self.world_tree.write(file_path)
    #     self.reload_model(file_path)
    #
    # def set_goal(self, goal_position):
    #     """ set goal position """
    #     self.goal_position = goal_position
