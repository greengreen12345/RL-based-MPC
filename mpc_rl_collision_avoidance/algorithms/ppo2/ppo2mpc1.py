...
class Runner(AbstractEnvRunner):
    ...
    def _run(self):
        ...
        for _ in range(self.n_steps):
            ...
            goal_state = actions + x0
            optimal_U_opti = self.mpc.get_optimal_control(x0, goal_state)
...
class MPCRunner(AbstractEnvRunner):
    ...
    def _run(self):
        ...
        while step_it < self.n_steps:
            ...
            observation = self.env.reset()
            x0 = observation['observation'][:3].T
            optimal_U_opti, actions = self.agent.mpc_output(x0, self.goal_state, self.goal_states)
